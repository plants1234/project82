...
function my_mousemove(e)
{
    ...
    if (mouseEvent == "mouseDown")
    {
        ...
        console.log("Last position of x andy coordinates = ");
        console.log("x = " + last_positon_of_x + "y = " + last_position_of_y);
        ctx.moveTo(last_position_of_x, last_position_of_y);

        console.log("Current position of x andy coordinates = ");
        console.log("x = " + current_positon_of_mouse_x + "y = " + current_position_of_mouse_y);
        ctx.moveto(current_position_of_mouse_x, current_position_of_mosue_y);
        ctx.stroke();
    }
